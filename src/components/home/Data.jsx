...
const Data = () => {
  return (
    <div className="home__data">
        <h1 className="home__title">SATYAM KUMAR
        <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <p className="home__description">"Turning ideas into smooth and functional websites—I'm a full stack developer who creates intuitive and user-friendly online experiences."</p>
